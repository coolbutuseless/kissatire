...
# test_that("kis_solve_satire() works", {
#   
#   sat <- satire::sat_new()
...
#   # solns 
#   
#   solns <- kis_solve_satire(sat, max_solutions = 15)
#   solns
#   
#   
...
test_that("kis_solve_literals() unsatisfiable returns NULL", {
  expect_null(
    kis_solve_literals(c(1, 0, -1, 0))
  )
})
